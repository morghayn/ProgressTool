...
VALUES (1, 1, '/media/com_progresstool/icons/Illustrations_Reflexions.jpg', 200, 135, 0, 9),
       ...
       (4, 4, '/media/com_progresstool/icons/Illustrations_Formations.jpg', 175, 131, 0, 0),
       (5, 5, '/media/com_progresstool/icons/Illustrations_Lien.jpg', 200, 177, 50, 8),
       (6, 8, '/media/com_progresstool/icons/Illustrations_MobilisationFinance.jpg', 250, 180, 10, 20),
       (7, 9, '/media/com_progresstool/icons/Illustrations_MobilisationFinance.jpg', 250, 180, 10, 20),
       (8, 10, '/media/com_progresstool/icons/Illustrations_Inauguration.jpg', 368, 175, 30, 55),
       (9, 11, '/media/com_progresstool/icons/Illustrations_Inauguration.jpg', 368, 175, 40, 55),
       (10, 12, '/media/com_progresstool/icons/Illustrations_Compta.jpg', 250, 250, 45, 5),
       (11, 13, '/media/com_progresstool/icons/Illustrations_Compta.jpg', 250, 250, 45, 5),
       (12, 14, '/media/com_progresstool/icons/Illustrations_Compta.jpg', 200, 200, 65, 5),
       (13, 15, '/media/com_progresstool/icons/Illustrations_Administratif.jpg', 155, 151, 75, 55),
       (14, 16, '/media/com_progresstool/icons/Illustrations_Chantier.jpg', 270, 143, 32, 66),
       (15, 17, '/media/com_progresstool/icons/Illustrations_MobilisationFinance.jpg', 265, 189, 30, 123),
       (16, 18, '/media/com_progresstool/icons/Illustrations_InitiativesLocale02.jpg', 235, 197, 58, 166),
       (17, 20, '/media/com_progresstool/icons/Illustrations_Inauguration.jpg', 350, 167, 60, 115),
       (18, 21, '/media/com_progresstool/icons/Illustrations_Chantier.jpg', 312, 165, 55, 43),
       (19, 22, '/media/com_progresstool/icons/Illustrations_Compta.jpg', 215, 215, 50, 65),
       (20, 23, '/media/com_progresstool/icons/Illustrations_PouceOK.jpg', 113, 113, 100, 75),
       (21, 24, '/media/com_progresstool/icons/Illustrations_MobilisationFinance.jpg', 265, 191, 90, 75),
       (22, 25, '/media/com_progresstool/icons/Illustrations_Banque.jpg', 375, 173, 30, 56),
       (23, 26, '/media/com_progresstool/icons/Illustrations_VisiteChantier.jpg', 375, 186, 0, 5),
       (24, 27, '/media/com_progresstool/icons/Illustrations_Management.jpg', 150, 160, 0, 0),
       (25, 28, '/media/com_progresstool/icons/Illustrations_Chantier.jpg', 290, 153, 29, 228),
       (26, 29, '/media/com_progresstool/icons/Illustrations_VisiteChantier.jpg', 270, 134, 0, 0),
       (27, 30, '/media/com_progresstool/icons/Illustrations_Argent01.jpg', 150, 169, 65, 15),
       (28, 31, '/media/com_progresstool/icons/Illustrations_Formations.jpg', 220, 163, 10, 110),
       (29, 32, '/media/com_progresstool/icons/Illustrations_Lien.jpg', 175, 155, 35, 0),
       (30, 33, '/media/com_progresstool/icons/Illustrations_AvionPapier.jpg', 350, 262, 0, 0);
...
VALUES (1, 1, 'No', 0),
       ...
       (27, 6,
        'Yes, the group has investigated local resources that may be suitable for a RE project, i.e. available rooftop space, unused fields for wind turbines or readily available bioenergy fuel', 1),
       ...
       (32, 7,
        'Yes, the group has investigated local resources that may be suitable for a RE project, i.e. available rooftop space, unused fields for wind turbines or readily available bioenergy fuel', 1),
       (33, 8, 'No', 0),
       (34, 8, 'Yes, the group is a registered SEC with SEAI', 1),
       (35, 8, 'Yes, the group has official support from local bodies such as SEC mentors', 1),
       ...
       (43, 10, 'No', 0),
       (44, 10, 'Yes, with public partners', 1),
       ...
       (65, 14, 'No', 0),
       (66, 14, 'Options have been presented to the group', 1),
       (67, 14, 'Yes, a decision has been made', 2),
       (68, 15, 'No', 0),
       (69, 15, 'Yes, it is ongoing', 1),
       (70, 15, 'Yes, the findings were positive and have been shared with the group', 1),
       (71, 15, 'The project is not viable and must be discontinued', 1),
       (72, 16, 'No', 0),
       ...
       (106, 23, 'The file is being reviewed', 1),
       (107, 23, 'The project is being appealed ', 1),
       (108, 23, 'Yes, there has been administration approval', 2),
       ...
       (115, 25, 'No', 0),
       (116, 25, 'Through a bank loan', 1),
       (117, 25, 'Through members’ investments', 1),
       (118, 25, 'Through a government funding scheme', 1),
       (119, 26, 'No', 0),
       ...
       (137, 29, 'Not yet, there has been a group visit to the construction site\r\n', 1),
       (138, 29, 'Not yet, plans are in place for preparation of operation monitoring', 1),
       (139, 30, 'No', 0),
       ...
       (155, 29, 'Yes, construction is complete and it has been inaugurated', 1),
       (156, 29, 'Yes, with ongoing communication regarding the operation', 1);
...
VALUES (1, 1, 1, 'Awareness activities about existing Beacon projects, Educational actions of local associations, Private developer prospection'),
       ...
       (3, 1, 1, 'Leading group'),
       (4, 1, 2, 'Masterclasses: democratic organisation of the citizen group, Legal structuring, Technical issues, Initial financial elements, Expansion of the citizen group'),
...
(
    ...
    FOREIGN KEY (`task_id`) REFERENCES `#__pt_task` (`id`) ON DELETE CASCADE,
    FOREIGN KEY (`choice_id`) REFERENCES `#__pt_question_choice` (`id`) ON DELETE CASCADE
)
    ENGINE = InnoDB
    AUTO_INCREMENT = 0

...
/**
    Add project table (to be activated via preliminary questions)
    Add project question choice table
 */
CREATE TABLE `#__question`
(
    `id`        INT(11)      NOT NULL AUTO_INCREMENT,
    `question`  VARCHAR(255) NOT NULL,
    `primary`   VARCHAR(6)   NOT NULL DEFAULT '507bfb',
...
VALUES ('Has your community hosted awareness activities surrounding the energy transition?', 'ff6600'),
       ...
       ('Has there been any meetings with potential partners or mentors?', '993399');
...
VALUES (1, 'No'),
       ...
       (1, 'Yes, there has been local initiatives about coming up with new ideas. These can include ‘Town hall’ meetings or '),
       (2, 'No'),
       (2, 'Yes, regarding the type of governance that would be involved e.g. Co-operative or Sustainable Energy Community with SEAI (SEC)'),
       ...
       (3, 'No'),
       (3, 'No, but there is interest from the community to form one'),
       (3, 'Yes, there is a leading group that has been democratically organized and formed with members of the local community '),

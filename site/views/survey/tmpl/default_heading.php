...
<p class="abstract">
    ...
    <br><br>Please select all answer options that apply to your project, feel free to choose more than one option. You do not need to answer every
    question in this survey, the results will be calculated from the given answers.

    <br><br>The choices associated with a question will collapse when it is considered complete, these can be accessed again by clicking on the
    question.
</p>